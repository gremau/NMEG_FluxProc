...
for i=1:ncol;
    if strcmp('RH',headertext(i)) == 1 || strcmp('rh_hmp', headertext(i)) == 1  
        rH = data(:,i-1);
    end
end
...
for i=1:ncol;
    ...
    elseif strcmp('Tsoil',headertext(i)) == 1 || strcmp('Tsoil_avg',headertext(i)) == 1 || ...
            ...
            elseif strcmp('soilT_Avg(1)',headertext(i)) == 1
            Tsoil_1 = data(:,i-1);
            elseif strcmp('soilT_Avg(2)',headertext(i)) == 1
            Tsoil_2 = data(:,i-1);
            elseif strcmp('soilT_Avg(3)',headertext(i)) == 1
            Tsoil_3 = data(:,i-1);
            elseif strcmp('VWC(1)',headertext(i)) == 1 || strcmp('soil_water_T(1)',headertext(i))
            SWC_1 = data(:,i-1);
            elseif strcmp('VWC(2)',headertext(i)) == 1 || strcmp('soil_water_T(2)',headertext(i))
            SWC_2 = data(:,i-1);
            elseif strcmp('VWC(3)',headertext(i)) == 1 || strcmp('soil_water_T(3)',headertext(i))
            SWC_3 = data(:,i-1);
...
%     xlswrite(outfilename,timestamp,'data','A2');
    ...
    if sitecode == 1 || sitecode == 2 % use old partitioning
    NEE_f=pt1_in(:,11);
    RE_f =pt1_in(:,10);
    GPP_f=pt1_in(:,6);
    VPD_f=gf_in(:,18);
    ...
    HL_wpl_massman(isnan(E_wpl_massman))=NaN;
     ...
     elseif sitecode == 4 % Pinon-juniper
        ...
        datamatrix3 = [year,intjday,(hour.*100)+minute,jdayout,u_star,air_temp_hmp,wnd_dir_compass,wnd_spd,...
            dummy,fc_raw_massman_wpl,dummy,HSdry_massman,dummy,HL_wpl_massman,dummy,soil_heat_flux_1,...
        ...
        datamatrix4 = [year,intjday,(hour.*100)+minute,jdayout,u_star,Tair_f,TA_flag,wnd_dir_compass,wnd_spd,...
            dummy,NEE_f,NEE_flag,dummy,HSdry_massman,dummy,LE_f,LE_flag,dummy,soil_heat_flux_1,...
