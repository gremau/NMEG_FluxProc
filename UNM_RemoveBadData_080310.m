...
function [] = UNM_RemoveBadData_080310(sitecode,year)
%clear all
%close all
...
for i=1:ncol;
    ...
    elseif strcmp('hfp_grass_1_Avg', headertext(i))==1  %this test added 27 Oct 2011 -TWH
        soil_heat_flux_1 = data(:,i-1);
        disp('FOUND hfp_grass_1_Avg');       
    elseif strcmp('hfp_grass_2_Avg', headertext(i))==1  %this test added 27 Oct 2011 -TWH
...
if sitecode == 1 %GLand   added TWH, 27 Oct
    for i=1:ncol;
...
%         plot(elementstouse_c,10+mean_conc(i),'m'); hold on
    ...
    plot(decimal_day(xx), yy,'go-'); hold ondbstop
