...
filedir=strcat(drive,'\','Research_Flux_Towers\', 'Flux_Tower_Data_by_Site\' ...
               ,site,'\ts_data\');
...
filedir = fullfile( 'i:', 'Raw uncompressed data folders', 'TX Data', 'TX2010', ...
                    'ConvertedCardData' );
outfolder=strcat(drive,'\','Research_Flux_Towers\','Flux_Tower_Data_by_Site\',...
                 site,'\matlab output\');
sitedir=strcat(drive,'\','Research_Flux_Towers\','Flux_Tower_Data_by_Site\', ...
               site,'\');
