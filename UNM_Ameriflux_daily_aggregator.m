...
% author: Timothy W. Hilton, UNM, December 2012
    ...
    methods
        ...
        function obj = aggregate_daily( obj )
            ...
            [ t, TA_min ] = ...
                consolidator( t_30min, obj.aflx_data.( 'TA' ), ...
                @nanmin );
            ...
            obj.daily_data = ...
                array2table( [t, data_sum, data_mean, TA_min, TA_max, ...
        ...
        function write_daily_file( obj, varargin )
            ...
            fname = fullfile( outdir, ...
                sprintf( '%s_%d_%d_daily_branch.txt', ...
                site_abbrev, ...
                obj.years( 1 ), ...
                obj.years( end ) ) );
            
            fprintf( 'writing %s\n', fname );
            warning( 'Converting table to dataset!' );
            export_dataset_tim( fname, ...
                table2dataset( obj.daily_data ), ...
                'replace_NaNs', -9999, ...
                'write_units', true );
        end
