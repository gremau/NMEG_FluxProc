...
datain=dlmread('PJ_C_CO2_data_for_Dan.csv',',',1,0);        
...
dlmwrite('Filled_PJ_C_CO2_data_for_Dan.csv',data_filled);
...
data_filled=dlmread('Filled_PJ_C_CO2_data_for_Dan.csv');
...
%         plot(SWC_3,'g'); hold on
        ...
        dlmwrite('PJ_SWC.txt',cat(2,data_filled(:,2:4),vwc4,pinon_mean',juniper_mean',open_mean',shallow_mean',medium_mean',deep_mean'))
