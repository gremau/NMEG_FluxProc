...
fid = fopen('C:\Research_Flux_Towers\Flux_Tower_Data_by_Site\TX_forest\2005\problem1\combined.dat');
data = fread(fid);
...
fwrite('C:\Research_Flux_Towers\Flux_Tower_Data_by_Site\TX_forest\2005\problem1\combined2.dat','data_to_write');
