...
datarange = strcat('BY',num2str(first_row),':','FT',num2str(last_row)); % specify what portion of spreadsheet to read in
headerrange = strcat('BY2:FT2'); % specify portion of spreadsheet that is headers
