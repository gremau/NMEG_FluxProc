...
function [] = UNM_30min_flux_processor_071610(sitecode,year,first_row,last_row)
...
elseif (sitecode == 6) & (year == 2011)
    fprintf( 'using MCon 2011 section\n');
    keyboard
    DATAOUT = [jday,blank',umean,vmean,wmean,Ts_meanC,TD,wind_direction, ...
               wind_speed,blank', cov_Ux_Ux, cov_Uz_Uz, cov_Uy_Uy, ...
               Ts_meanK, uw, vw, uv, cov_Ts_Ux, cov_Ts_Uy, cov_Ts_Uz, ...
               USTAR', blank', blank', blank', co2_mean_out, blank', blank', ...
               blank', blank', h2o_Avg_out, blank', Fc_raw', ...
               flux_co2_massman', Fc_water_term', Fc_heat_term_massman', ...
               Fc_corr_massman_ourwpl', flux_h2o', ...
               flux_h2o_massman', E_water_term', E_heat_term_massman',...
               E_corr_massman', blank', HSdry', HSwet', HSwetwet', ...
               HSdry_massman', flux_HL', flux_HL_massman', ...
               flux_HL_wpl_massman', rhoa_out',rhov_out',rhoc_out'];
else
