...
drive='c:';
row1=5236;  %TWH first row of data to process - rows 1 - 4 are header
...
time_stamp_range = sprintf('A%d:A%d', row1, filelength_n);
...
if sitecode == 1
    if year2 == 2007
        ...
        % correct calibration factor as per 23 Oct 2011 email from James
        % Heilman -- TWH
        sw_incoming = (sw_incoming ./ 136.99) * 112.23;
        sw_outgoing = (sw_outgoing ./ 136.99) * 112.23;  
        lw_incoming = (lw_incoming ./ 136.99) * 112.23;
        lw_outgoing = (lw_outgoing ./ 136.99) * 112.23;
...
elseif sitecode == 7
    if year2 == 2007 || year2 == 2006 || year2 == 2005
        ...
        if year2 == 2006
            Par_Avg(15000:length(Par_Avg)) = (Par_Avg(15000: ...
                                                      length(Par_Avg)).* ...
                                              1.4339)+0.1248; 
            % There seems to be a shift in calibration at this point to unknown value. This
            %is based on regression with woodland PAR at end of 2006
        elseif year2 == 2007
