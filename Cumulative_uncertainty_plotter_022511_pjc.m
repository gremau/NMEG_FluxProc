...
afnames(5,:)='US-Vcp'; % 5-PJ
afnames(6,:)='US-Vcm'; % 6-PJ
...
% PJ_07 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2008_gapfilled.txt');
PJ_08 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2009_gapfilled.txt');
PJ_09 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2010_gapfilled.txt');
PJ_10 = dlmread(filename,'',5,0);



%PJ_07(PJ_07==-9999)=nan; 
PJ_08(PJ_08==-9999)=nan; PJ_09(PJ_09==-9999)=nan;PJ_10(PJ_10==-9999)=nan;

%cum_nee(:,1)=PJ_07(1:17416,11);
cum_nee(:,2)=PJ_08(1:17416,11);
cum_nee(:,3)=PJ_09(1:17416,11);
cum_nee(:,4)=PJ_10(1:17416,11);
...
for i =1:ndays
  % daily_values(i,1)=sum(PJ_07(PJ_07(:,2)==i,11).*0.0216);
   daily_values(i,2)=sum(PJ_08(PJ_08(:,2)==i,11).*0.0216); 
   daily_values(i,3)=sum(PJ_09(PJ_09(:,2)==i,11).*0.0216); 
   daily_values(i,4)=sum(PJ_10(PJ_10(:,2)==i,11).*0.0216); 
end
...
figure;
%plot(out_08(2,:),'r','linewidth',3); hold on % for legend
