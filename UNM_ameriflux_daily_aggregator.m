...
% --------------------------------------------------
    ...
    vars_mean = { 'TA', 'UST', 'WS', 'PA', 'CO2', 'VPD', 'H20' };
    units_mean = { 'deg C', 'm s-1', 'm s-1', 'Pa', 'ppm', '-', '?' };
    ...
    vars = horzcat( { 'year', 'doy' }, ...
                    vars_sum, vars_mean, vars_Cfluxes, vars_rad );
    obj.daily_data = ...
        dataset( { [ t, data_sum, data_mean, data_fluxes, data_rad ], ...
                   vars{ : } } );
    obj.daily_data.Properties.Units = horzcat( units_time, units_sum, ...
                                               units_mean, units_Cfluxes, ...
                                               units_rad );
