...
SLand_07 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2008_gapfilled.txt');
SLand_08 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2009_gapfilled.txt');
SLand_09 = dlmread(filename,'',5,0);
filename = strcat(afnames(sitecode,:),'_2010_gapfilled.txt');
SLand_10 = dlmread(filename,'',5,0);


SLand_07(SLand_07==-9999)=nan; 
SLand_08(SLand_08==-9999)=nan; 
SLand_09(SLand_09==-9999)=nan; 
SLand_10(SLand_10==-9999)=nan;

cum_nee(:,1)=SLand_07(1:17416,11);
cum_nee(:,2)=SLand_08(1:17416,11);
cum_nee(:,3)=SLand_09(1:17416,11);
cum_nee(:,4)=SLand_10(1:17416,11);
...
for i =1:ndays
   daily_values(i,1)=sum(SLand_07(SLand_07(:,2)==i,11).*0.0216);
   daily_values(i,2)=sum(SLand_08(SLand_08(:,2)==i,11).*0.0216); 
   daily_values(i,3)=sum(SLand_09(SLand_09(:,2)==i,11).*0.0216); 
   daily_values(i,4)=sum(SLand_10(SLand_10(:,2)==i,11).*0.0216); 
end
