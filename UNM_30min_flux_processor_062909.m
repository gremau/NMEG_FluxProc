...
datarange = strcat('BT',num2str(first_row),':','GA',num2str(last_row)); % specify what portion of spreadsheet to read in
headerrange = strcat('BT2:GA2'); % specify portion of spreadsheet that is headers
...
datarange2 = strcat('J',num2str(first_row),':BQ',num2str(last_row));
