...
datain=dlmread('Gland_2010_swc_data.csv',',',1,0);        
...
data_filled=dlmread('Filled_Gland_2010_swc_data.csv');

% Bring in the SWC data
vwc2=data_filled(:,5:22);
...
open_5_mean=nanmean(vwc4(:,[11 15])');
open_12_mean=nanmean(vwc4(:,[12 16])');
open_22_mean=nanmean(vwc4(:,[13 17])');
open_37_mean=nanmean(vwc4(:,[14 18])');

site_5_mean=nanmean(vwc4(:,[1 6 11 15])');
site_12_mean=nanmean(vwc4(:,[2 7 12 16])');
site_22_mean=nanmean(vwc4(:,[3 8 13 17])');
site_37_mean=nanmean(vwc4(:,[4 9 14 18])');
site_52_mean=nanmean(vwc4(:,[5 10])');
...
%         plot(SWC_3,'g'); hold on
        ...
        dlmwrite('Gland_2010_SWC.txt',cat(2,data_filled(:,2:4),vwc4,grass_5_mean',grass_12_mean',grass_22_mean',grass_37_mean',grass_52_mean',open_5_mean',open_12_mean',open_22_mean',open_37_mean',site_5_mean',site_12_mean',site_22_mean',site_37_mean',site_52_mean' ))
