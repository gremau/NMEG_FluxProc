function success = build_TOA5_card_convert_ccf_file(ccf_file, raw_data_dir, ...
                                                    toa5_data_dir)
% BUILD_TOA5_CARD_CONVERT_CCF_FILE - writes a configuration file for campbell
%   scientific card convert.  This file format was derived by following the
%   instructions in the manual for LoggerNet v 4.1 (section 8.3.5; Running
