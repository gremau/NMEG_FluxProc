...
raw_data_dir = fullfile('I:', 'Raw uncompressed data folders', 'JSav', 'JSav_10-05-11')
%raw_data_dir = 'I:\Raw uncompressed data folders\FromSkyler\SLand_10-04-11';
mod_date = datenum(2011, 10, 05, 10, 53, 00);
