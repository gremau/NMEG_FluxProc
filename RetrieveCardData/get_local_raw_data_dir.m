...
% files.  Data are placed within the directory returned by
% get_site_directory().  Within this root, the path returned follows the UNM
% convention of placing raw data in Raw_Data_YYYY/SITE_mm-dd-yy, with YYYY
% the four-digit year, mm the two-digit month, dd the two-digit day of month,
% and yy the two digit year (all dates and time determined from mod_date),
% and SITE the abbreviated site name determined from site argument.
%
% USAGE
